...
public abstract class BaseDAO<T> {
    ...
    public BaseDAO() {
        ...
        try {
            ...
            e.printStackTrace();
            throw new DAOException("BaseDAO 构造方法出现异常，可能的原因是没有指定<>中的类型");
        }
    ...
    protected int executeUpdate(String sql, Object... params) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new DAOException("BaseDAO executeUpdate出现异常");
        }
    }
    ...
    protected Object[] executeComplexQuery(String sql, Object... params) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new DAOException("BaseDAO executeComplexQuery出现异常");
        }
    ...
    protected T load(String sql, Object... params) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new DAOException("BaseDAO load出现异常");
        }
        return null;
    }
    ...
    protected List<T> executeQuery(String sql, Object... params) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new DAOException("BaseDAO executeQuery出现异常");
        }
